...
var DiffViewer = /** @class */ (function (_super) {
    ...
    function DiffViewer(props) {
         ...
         */
        _this.renderLine = function (lineNumber, type, prefix, value, uniqueLineId, additionalLineNumber, additionalPrefix) {
            var _a, _b, _c, _d, _e;
            ...
            if (Array.isArray(value)) {
                content = _this.renderWordDiff(value, uniqueLineId, _this.props.renderContent);
            }
            else if (_this.props.renderContent) {
                content = _this.props.renderContent(value, uniqueLineId);
            }
            else {
                content = value;
            }
            return (React.createElement(React.Fragment, null,
                !_this.props.hideLineNumbers && (React.createElement("td", { onClick: lineNumber &&
                        _this.onLineNumberClickProxy(lineNumberTemplate, uniqueLineId), className: classnames_1.default(_this.styles.gutter, (_a = {},
                ...
                !_this.props.splitView && !_this.props.hideLineNumbers && (React.createElement("td", { onClick: additionalLineNumber &&
                        _this.onLineNumberClickProxy(additionalLineNumberTemplate, uniqueLineId), className: classnames_1.default(_this.styles.gutter, (_b = {},
                ...
                React.createElement("td", { className: classnames_1.default(_this.styles.content, _this.styles.plusWrapper, (_d = {},
                    ...
                    React.createElement("button", { className: classnames_1.default(_this.styles.plusBtn, (_e = {
                                isPlusBtnShown: (added || removed) &&
                                    !_this.props.commentLineIds.includes(uniqueLineId)
                            },
                            _e[_this.props.plusBtnClassName] = _this.props.plusBtnClassName,
                            _e)), onClick: _this.getUniqueLineIdProxy(uniqueLineId) }, "+"))));
        };
        /**
         *
         * renders plusBtn
         ...
         *
         */
        _this.renderPlusButton = function (isShown, uniqueLineId) {
            if (!isShown || _this.props.commentLineIds.includes(uniqueLineId)) {
                return null;
            }
            return (React.createElement("button", { className: _this.styles.plusBtn, onClick: _this.getUniqueLineIdProxy(uniqueLineId) }, "+"));
        };
        /**
         *
         ...
         *
         */
        _this.getUniqueLineIdProxy = function (uniqueLineId) {
            if (_this.props.getLineId) {
                return function () { return _this.props.getLineId(uniqueLineId); };
            }
            return function () { };
        };
        _this.generateUniqueLineId = function (lineNumber, specifier, prefix) {
            return prefix + "-" + lineNumber + "-" + specifier + "-" + _this.props.fileId;
        };
        /**
         *
         ...
         *
         */
        _this.renderSplitCommentBlockProxy = function (leftId, rightId) {
            ...
            if (lineIdsArray.includes(leftId) || lineIdsArray.includes(rightId)) {
                return (React.createElement("tr", null,
                    React.createElement("td", { colSpan: 3 }, lineIdsArray.includes(leftId) &&
                        _this.props.renderCommentBlock(leftId)),
                    React.createElement("td", { colSpan: 3 }, lineIdsArray.includes(rightId) &&
                        _this.props.renderCommentBlock(rightId))));
            }
            return null;
        };
        /**
         ...
         *
         */
        _this.renderInlineCommentBlockProxy = function (uniqueLineId) {
            if (_this.props.commentLineIds &&
                _this.props.commentLineIds.includes(uniqueLineId)) {
                return (React.createElement("tr", null,
                    React.createElement("td", { colSpan: 6 }, _this.props.renderCommentBlock(uniqueLineId))));
            }
            return null;
        };
        /**
        ...
        _this.renderSplitView = function (_a, index) {
            ...
            var leftId = _this.generateUniqueLineId(left.lineNumber, _this.props.beforeCommit + "-" + _this.props.afterCommit, LineNumberPrefix.LEFT);
            var rightId = _this.generateUniqueLineId(right.lineNumber, _this.props.beforeCommit + "-" + _this.props.afterCommit, LineNumberPrefix.RIGHT);
            return (React.createElement(React.Fragment, { key: index },
                React.createElement("tr", { className: _this.styles.line },
                    _this.renderLine(left.lineNumber, left.type, LineNumberPrefix.LEFT, left.value, leftId),
                    _this.renderLine(right.lineNumber, right.type, LineNumberPrefix.RIGHT, right.value, rightId)),
                _this.renderSplitCommentBlockProxy(leftId, rightId)));
        };
        /**
        ...
        _this.renderInlineView = function (_a, index) {
            ...
            if (left.type === compute_lines_1.DiffType.REMOVED && right.type === compute_lines_1.DiffType.ADDED) {
                return (React.createElement(React.Fragment, { key: index },
                    React.createElement("tr", { className: _this.styles.line }, _this.renderLine(left.lineNumber, left.type, LineNumberPrefix.LEFT, left.value, leftId, null)),
                    _this.renderInlineCommentBlockProxy(leftId),
                    React.createElement("tr", { className: _this.styles.line }, _this.renderLine(null, right.type, LineNumberPrefix.RIGHT, right.value, rightId, right.lineNumber)),
                    _this.renderInlineCommentBlockProxy(rightId)));
            }
            if (left.type === compute_lines_1.DiffType.REMOVED) {
                content = _this.renderLine(left.lineNumber, left.type, LineNumberPrefix.LEFT, left.value, leftId, null);
                currLineId = leftId;
            }
            if (left.type === compute_lines_1.DiffType.DEFAULT) {
                content = _this.renderLine(left.lineNumber, left.type, LineNumberPrefix.LEFT, left.value, leftId, right.lineNumber, LineNumberPrefix.RIGHT);
                currLineId = leftId;
            }
            if (right.type === compute_lines_1.DiffType.ADDED) {
                content = _this.renderLine(null, right.type, LineNumberPrefix.RIGHT, right.value, rightId, right.lineNumber);
                currLineId = rightId;
            }
            return (React.createElement(React.Fragment, null,
                React.createElement("tr", { key: index, className: _this.styles.line }, content),
                _this.renderInlineCommentBlockProxy(currLineId)));
        };
        /**
